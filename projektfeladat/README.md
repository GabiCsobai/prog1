...
A program használata: Futtatáskor parancssori argumentumként meg kell adni a nyelvet éa/vagy egy kapcsolót a következő módon: 
    
    alap nyelvazonosító [--stdout] VAGY [-v, --version] | [-h, --help]
